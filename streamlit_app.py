...
def main():
    ...
    # ------- Onglet Terminal -------
    with tabs[1]:
        st.markdown("Tape une commande puis **Entrée** (ex: `AddSub S1 R1`, `AddRole R1`, `GrantPermission R1 R O1`, `AddCh E1 E2`, `S2 AddObj O2`, `S2 Grant S3 O2 R`, `show`, `Never {A,B} for E1`, …)")
