...
def apply_prompt(df: pd.DataFrame, prompt: str):
  ...
  # S'assure que les colonnes existent toujours
    ...
    if cmd == "GrantPermission":
        ...
        # Propagation aux sujets ayant déjà ce rôle
    ...
    if cmd == "AddSub":
        ...
        if role:
            ...
            # Hériter des permissions du rôle
